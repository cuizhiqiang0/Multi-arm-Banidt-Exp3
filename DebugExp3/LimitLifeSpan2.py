...
if __name__ == '__main__':
    ...
    fileSig = '2_Exp3_LimitedLifeSpan'								# depending on further environment parameters a file signature to remember those. for example if theta is set every two hours i can have it '2hours'; for 
        ...
        with open(fileName, 'r') as f:
            ...
            for line in f:
                ...
                for article in currentArticles:
                    ...
                    if articles_exp3[article].LifeSpanCounter >= LifeSpanThreshold:
