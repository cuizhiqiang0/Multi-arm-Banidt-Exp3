...
if __name__ == '__main__':
    ...
    fileSig = 'Exp3_AvoidOld'								# depending on further environment parameters a file signature to remember those. for example if theta is set every two hours i can have it '2hours'; for 
    ...
    dataDays = ['02', '05', '06', '07', '08', '09', '10'] # the files from Yahoo that the algorithms will be run on; these files are indexed by days starting from May 1, 2009. this array starts from day 3 as also in the test data in the paper
    ...
    for dataDay in dataDays:
        ...
        with open(fileName, 'r') as f:
            ...
            for line in f:
                ...
                if dataDay == '03':
                    if currentArticles.__contains__('109536'):
                        currentArticles.remove('109536')

                    if currentArticles.__contains__('109524'):
                        currentArticles.remove('109524')       
                ...
                if dataDay == '05':
                    if currentArticles.__contains__('109476'):
                        currentArticles.remove('109476')
                        print 'delete 109476 from', dataDay
                    
                        
                if dataDay == '07':
                    if currentArticles.__contains__('109635'):
                        currentArticles.remove('109635')
                ...
                if dataDay == '09':
                    if currentArticles.__contains__('109667'):
                        currentArticles.remove('109667')
                        
                    if currentArticles.__contains__('109697'):
                        currentArticles.remove('109697')
