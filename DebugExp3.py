...
if __name__ == '__main__':
    ...
    fileSig = 'Half_MultipleDay'								# depending on further environment parameters a file signature to remember those. for example if theta is set every two hours i can have it '2hours'; for 
    ...
    dataDays = ['03', '04', '05', '06'] # the files from Yahoo that the algorithms will be run on; these files are indexed by days starting from May 1, 2009. this array starts from day 3 as also in the test data in the paper
    ...
    for dataDay in dataDays:
        ...
        with open(fileNameWrite, 'a+') as f:
            ...
            f.write('\n, Time, randomAccesses; randomClicks; exp3Access; exp3Clicks; ucb1Accesses; ucb1Clicks; greedyAccesses; greedyClicks; exp3CTRRatio; ucb1CTRRatio; greedyCTRRatio\n')
