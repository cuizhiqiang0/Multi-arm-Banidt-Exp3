...
if __name__ == '__main__':
    ...
    def greedySelectArm(epsilon, articles):
        flag = 0
        for x in articles:
            if articles_greedy[x].numPlayed < 10:
                flag = 1
                return x
        if flag == 0:
    ...
    fileSig = 'epsilonSacrifice10_0.05'								# depending on further environment parameters a file signature to remember those. for example if theta is set every two hours i can have it '2hours'; for
