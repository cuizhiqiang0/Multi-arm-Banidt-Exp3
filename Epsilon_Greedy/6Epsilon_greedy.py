...
if __name__ == '__main__':
    ...
    fileSig = 'epsilon0.6_Multi'								# depending on further environment parameters a file signature to remember those. for example if theta is set every two hours i can have it '2hours'; for
